...
кликом, поддерживает кислород, пайки и оборудование центров и реагирует на
...
[![Курьер движется по плавному маршруту вокруг опасной зоны; справа открыта карточка выбранного ровера](docs/screenshots/04-route-and-inspector.png)](docs/screenshots/04-route-and-inspector.png)

_Маршрут можно перестроить во время движения, не останавливая ровер._

### Выбор экспедиции

[![Каталог пяти экспедиций с выбранным уровнем «Разлом Шеклтона»](docs/screenshots/01-level-select.png)](docs/screenshots/01-level-select.png)

### Брифинг миссии

[![Брифинг «Разлома Шеклтона» с картой, риском и составом экспедиции](docs/screenshots/02-mission-briefing.png)](docs/screenshots/02-mission-briefing.png)

### Обзор смены

[![Игровая карта с базой, научными центрами, роверами и опасной зоной](docs/screenshots/03-gameplay-overview.png)](docs/screenshots/03-gameplay-overview.png)

### Авария и спасение

[![Повреждённый курьер сообщает об аварии, а ремонтный ровер направляется к нему](docs/screenshots/05-rover-incident.png)](docs/screenshots/05-rover-incident.png)

### Рация

[![Развёрнутая рация с хронологией событий и карточкой повреждённого ровера](docs/screenshots/06-radio-log.png)](docs/screenshots/06-radio-log.png)

_Рация сохраняет хронологию заявок, доставок и аварийных событий._

## Исходная спецификация

- [Исходный SDD-пакет v1.0.0](docs/source-spec/README.md) — неизменённые
  требования, feature-spec, контракты, задачи и промпты, из которых начиналась
  разработка.
- [Актуальные спецификации](specs/) — требования после принятых продуктовых
  изменений и финальной доводки игры.
